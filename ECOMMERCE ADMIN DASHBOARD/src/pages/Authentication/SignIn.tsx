...
const Login = () => {
  ...
  return (
    <>
      ...
      <div
        id="page-container"
        className="mx-auto flex min-h-dvh w-full min-w-[320px] flex-col bg-gray-700 dark:bg-gray-900 dark:text-gray-100"
      >
        {/* Page Content */}
          ...
          <div className="relative mx-auto flex min-h-dvh w-full max-w-10xl items-center justify-center overflow-hidden p-4 lg:p-8">
            ...
            <section className="w-full max-w-xl py-6">
              ...
              <header className="mb-10 text-center">
                <h1 className="mb-2 inline-flex items-center gap-2 text-3xl font-bold text-white">
                  <svg
                ...
                <h2 className="text-md text-white font-medium  dark:text-gray-400">
                ...
                <div className="grow p-5 md:px-16 md:py-12">
                  <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div>
                      ...
                      <button
                        type="submit"
                        className="inline-flex w-full items-center justify-center gap-2 rounded-lg border border-blue-700 bg-green-700 px-6 py-3 font-semibold leading-6 text-white hover:border-blue-600 hover:bg-pink-600 hover:text-white focus:ring focus:ring-blue-400/50 active:border-blue-700 active:bg-green-700 dark:focus:ring-blue-400/90"
                      >
                        <svg
