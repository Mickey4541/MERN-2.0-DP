...
@Table({
    tableName : 'categories', //tablename(always plural)
    modelName : 'category', //modelname is that name which we can use to access that table throughout the project. like we can use this name to create, find, update, delete.(singular and in pascal case)
