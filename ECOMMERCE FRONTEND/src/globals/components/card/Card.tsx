...
import { Product } from "../types/productTypes";
    ...
    const Card:React.FC<cardProps> = ({data}) => {
        ...
        <>
            ...
            <div className="container mx-auto px-5 md:py-8  flex flex-wrap justify-center">

            <div className="bg-purple-50 text-center p-6 transition-transform duration-500 hover:-translate-y-2 cursor-pointer w-full sm:w-1/2 lg:w-1/4 border border-blue-700 rounded-xl mb-3">
                <img 
                ...
                <h1 className="text-2xl my-4 text-black">{data?.productName}</h1>
                <p className="mb-4 text-black">{data?.productDescription}</p>
                <h2 className="text-xl font-semibold mb-4 text-black">${data.productPrice}</h2>
