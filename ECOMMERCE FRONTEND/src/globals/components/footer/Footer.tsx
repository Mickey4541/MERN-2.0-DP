    ...
    return (
        ...
        <div className="container px-4 mx-auto">
            ...
            <div className="px-4 my-4 w-full xl:w-1/5">
                ...
                <p className="text-justify">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex esse unde officia fuga consectetur velit laboriosam similique excepturi. Ducimus, quam!
                </p>
            </div>
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="px-4 w-full text-center sm:w-auto sm:text-left">
                ...
                RajanBhandari. All Rights Reserved.
            </div>
            <div className="px-4 w-full text-center sm:w-auto sm:text-left">
                Made with ❤️ by RajanBhandari.
            </div>
            </div>
        </div>
        </div>
