                    ...
                    <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                      ...
                      <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                        <div className="flex items-center border-gray-100">
                          <span className="cursor-pointer rounded-l bg-gray-700 py-1 px-3.5 duration-100 hover:bg-emerald-500 hover:text-blue-50" onClick={()=>handleUpdate(item?.Product?.id, item?.quantity - 1)}>-</span>
                          <input
                            ...
                            min="1"
                          />
                          <span className="cursor-pointer rounded-r bg-gray-700 py-1 px-3 duration-100 hover:bg-emerald-500 hover:text-blue-50" onClick={()=>handleUpdate(item?.Product?.id, item?.quantity + 1)}>+
                          </span>
                        </div>
