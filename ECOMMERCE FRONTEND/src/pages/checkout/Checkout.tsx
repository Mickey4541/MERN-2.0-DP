    ...
    return (
        ...
        <div className="pt-24 px-4 sm:px-10 lg:px-20 xl:px-32">
            {/* Flash Message */}
            {flashMessage && (
            <div className="bg-green-700 text-white text-center p-4 rounded-md mb-4">
                {flashMessage}
            </div>
            )}
            ...
            <div className="lg:w-1/2">
                ...
                Review your items and select a suitable shipping method.
                </p>
                ...
                items.map((item) => (
                    <div
                    key={item.Product.id}
                    className="mt-4 space-y-4 rounded-lg border bg-white px-4 py-1 shadow-lg"
                    >
                ...
                <div className="relative">
                    ...
                    <img
                        ...
                        src="../public/cash-on-delivery-banner.png"
                        alt="COD"
                    />
                    <div className="ml-5">
                        <span className="font-semibold peer-checked:text-gray-900">
            ...
            <form
                className="lg:w-1/2 bg-gray-100 rounded-lg shadow-lg px-4 pt-8 pb-2 h-fit"
            ...
            >
                ...
                {paymentMethod === PaymentMethod.khalti ? (
                    ...
                    <button
                    type="submit"
                    className="mt-4 mb-8 w-full rounded-md bg-green-700 px-6 py-3 font-medium text-white hover:bg-gray-800 transition duration-300"
                    >
                    Place Order
                    </button>
                )}
