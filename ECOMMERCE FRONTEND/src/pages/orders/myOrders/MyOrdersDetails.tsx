        ...
        <div className="py-24 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
            ...
            <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
    ...
    
               {
                ...
                <div className="flex justify-center flex-col items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
                <div className="flex flex-col px-4 py-6 md:px-6 xl:px-8 w-full bg-gray-50 dark:bg-gray-800 space-y-6">
            ...
            <div className="flex flex-col bg-gray-50 dark:bg-gray-800 w-full xl:w-96 px-4 py-4 xl:p-8 space-y-4">
                <h3 className="text-xl dark:text-white font-semibold leading-5 text-gray-800">
                Customer
                </h3>
